...
**Canonical reference:** `of1-build-prototypes` § post-gen fixes (5b — CSS class naming) and `stardust:deploy` § "Naming rules" (never name a block after a reserved EDS class).
