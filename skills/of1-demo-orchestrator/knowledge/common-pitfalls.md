...
**Canonical reference:** `of1-liftoff` (Stage 2's block-lift step — page-import onto standard blocks) and `stardust:deploy` § "Naming rules" (never name a block after a reserved EDS class).
