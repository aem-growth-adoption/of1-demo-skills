...
The gallery and the OF1 worker both read `templates/templates-catalog.json`. If Step 7 was short-circuited, this file may only contain the 4 page templates from Step 6 — the demo will work but the gallery will look empty.
